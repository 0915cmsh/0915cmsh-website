...
// 상세한 공지사항 데이터 (2023년 11월 ~ 2025년 9월) - 50개
const notices = [
  // 2025년 공지사항 (30개)
  {
  ...
  {
    title: 'CMSH 디지털 전환 가속화 및 스마트 워크플레이스 구축',
    content: 'CMSH가 디지털 전환을 가속화하여 스마트 워크플레이스를 구축합니다. 새로운 시스템은 다음과 같은 기능을 제공합니다: 1) 실시간 근무 현황 모니터링, 2) AI 기반 업무 효율성 분석, 3) 자동 급여 계산 시스템, 4) 모바일 앱 통합 관리. 이를 통해 고객사와 근로자 모두에게 더욱 편리하고 투명한 서비스를 제공할 수 있습니다. 시스템 도입으로 업무 효율성이 25% 향상되었으며, 고객 만족도도 크게 개선되었습니다.',
    author: '관리자',
    published: true,
  ...
  {
    title: '2025년 2분기 신규 서비스 런칭 및 고객 혜택 안내',
    content: '2025년 2분기에 새로운 서비스들이 런칭됩니다. 주요 신규 서비스는 다음과 같습니다: 1) 프리미엄 헤드헌팅 서비스, 2) 맞춤형 교육 프로그램, 3) 글로벌 인재 매칭 서비스, 4) ESG 경영 컨설팅. 신규 서비스 이용 고객에게는 특별 혜택을 제공합니다: 첫 달 서비스비 50% 할인, 전담 컨설턴트 배정, 우선 지원 서비스. 서비스 문의 및 상담은 고객센터로 연락주시기 바랍니다.',
    author: '관리자',
    published: true,
  ...
  {
    title: 'CMSH ESG 경영 강화 및 지속가능한 성장 전략',
    content: 'CMSH가 ESG(환경, 사회, 지배구조) 경영을 강화하여 지속가능한 성장을 추진합니다. 주요 ESG 활동은 다음과 같습니다: 1) 친환경 사무환경 구축, 2) 사회적 책임 실천 프로그램 운영, 3) 투명한 지배구조 확립, 4) 직원 복지 향상. 이러한 노력으로 ESG 평가에서 우수한 성과를 거두었으며, 지속가능한 기업으로 인정받았습니다. 앞으로도 사회적 가치 창출에 기여하는 기업이 되겠습니다.',
    author: '관리자',
    published: true,
  ...
  {
    title: '2025년 1분기 고객만족도 조사 결과 및 서비스 개선',
    content: '2025년 1분기 고객만족도 조사 결과를 발표합니다. 전체 고객 만족도는 93%를 기록했으며, 세부 항목별로는 서비스 품질(95%), 응답 속도(91%), 전문성(94%), 가격 경쟁력(92%) 순으로 나타났습니다. 고객 피드백을 바탕으로 다음과 같은 개선사항을 추진합니다: 1) 고객 맞춤형 서비스 강화, 2) 디지털 플랫폼 고도화, 3) 전문 인력 확충, 4) 가격 경쟁력 강화. 고객 여러분의 소중한 의견에 감사드리며, 지속적인 품질 향상을 위해 최선을 다하겠습니다.',
    author: '관리자',
    published: true,
  ...
  {
    title: 'CMSH 해외 진출 준비 및 글로벌 네트워크 구축',
    content: 'CMSH가 해외 진출을 준비하여 글로벌 네트워크를 구축합니다. 첫 번째 진출 국가는 베트남으로, 현지 파트너십을 통해 서비스를 제공할 예정입니다. 글로벌 서비스에는 다음과 같은 기능이 포함됩니다: 1) 다국어 지원 서비스, 2) 현지 법규 준수 시스템, 3) 글로벌 인재 데이터베이스, 4) 국제 인증 획득. 이를 통해 고객사의 해외 진출을 지원하고, 글로벌 인재 매칭 서비스를 제공할 수 있습니다.',
    author: '관리자',
    published: true,
  ...
  {
    title: '2025년 신년 인사 및 새로운 비전 발표',
    content: '2025년 신년을 맞아 고객 여러분께 감사 인사를 전합니다. 2024년 한 해 동안 CMSH는 고객 여러분의 신뢰와 성원 덕분에 큰 성장을 이루었습니다. 2025년에는 더욱 혁신적인 서비스와 고객 중심의 경영으로 새로운 도약을 준비하고 있습니다. 주요 목표는 다음과 같습니다: 1) AI 기반 서비스 고도화, 2) 전국 네트워크 확장, 3) 해외 진출 준비, 4) ESG 경영 강화. 고객 여러분과 함께 성장하는 CMSH가 되겠습니다.',
    author: '관리자',
    published: true,
  ...
  {
    title: 'CMSH 연말 감사인사 및 2025년 계획 발표',
