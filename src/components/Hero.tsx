    ...
    <section className="relative h-[70vh] flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
          ...
          <Link href="/inquiry/board" className="btn-secondary text-lg px-8 py-4 font-bold shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
            문의 게시판
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
          ...
          <div className="bg-black/50 backdrop-blur-sm rounded-xl p-4 border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
            <div className="text-3xl font-black text-white mb-1 drop-shadow-lg">95%+</div>
            <div className="text-blue-100 font-semibold drop-shadow-md">고객 만족도</div>
          </div>
          <div className="bg-black/50 backdrop-blur-sm rounded-xl p-4 border border-white/30 shadow-xl hover:shadow-2xl transition-all duration-300">
            <div className="text-3xl font-black text-white mb-1 drop-shadow-lg">전국</div>
            <div className="text-blue-100 font-semibold drop-shadow-md">네트워크 커버리지</div>
          </div>
        </div>
      </div>
