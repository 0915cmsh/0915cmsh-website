...
export const metadata = {
  title: '이용약관 - CMSH',
  description: 'CMSH의 이용약관을 확인해보세요.',
};
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <Section>
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">이용약관</h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <div className="prose prose-lg max-w-none">
              <h2>제1조 (목적)</h2>
              <p>
                이 약관은 CMSH(이하 "회사")가 제공하는 인재 솔루션 서비스의 이용과 관련하여 
              ...
              <ul>
                <li>"서비스"란 회사가 제공하는 인재 솔루션 관련 모든 서비스를 의미합니다.</li>
              ...
              <p>
                2. 회사는 합리적인 사유가 발생할 경우에는 이 약관을 변경할 수 있으며, 약관이 변경되는 경우 변경된 약관의 내용과 시행일을 정하여, 시행일로부터 최소 7일 이전에 공지합니다.
              </p>
